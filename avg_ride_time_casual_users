...
-- data format, which is difficult to work with, and converts it to minutes. The average ride time per month for casual users is then displayed
...
)/60 AS avg_ride_time_mins_casual
